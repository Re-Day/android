...
import com.project.reday.databinding.FragmentOnboardingBrokenDayBinding
import java.util.Calendar

class OnboardingBrokenDayFragment : Fragment() {

    lateinit var binding: FragmentOnboardingBrokenDayBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentOnboardingBrokenDayBinding.inflate(layoutInflater)
        ...
        binding.run {
            ...
            buttonNext.setOnClickListener {
                ...
                dateManager.saveDate("broken_day", editTextDate.text.toString())

                mainActivity.supportFragmentManager.beginTransaction()
                    .replace(R.id.fragmentContainerView_main, OnboardingReDayFragment())
                    .addToBackStack(null)
                    .commit()
            }
        }
